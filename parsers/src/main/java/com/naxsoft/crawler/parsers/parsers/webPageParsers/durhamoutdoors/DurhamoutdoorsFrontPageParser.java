package com.naxsoft.crawler.parsers.parsers.webPageParsers.durhamoutdoors;
...
public class DurhamoutdoorsFrontPageParser extends AbstractWebPageParser {
    ...
    public List<WebPageEntity> parse(WebPageEntity webPage) {
        return null;
//        return Observable.from(client.get("https://durhamoutdoors.ca/collections/", new DocumentCompletionHandler(webPage)))

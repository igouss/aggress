...
public class CanadiangunnutzRawPageParserTest extends AbstractTest {
    ...
    public void parse() throws Exception {
        ...
        try {
            ...
            WebPageEntity entity = new WebPageEntity(0L, IOUtils.toString(pageStream, "UTF-8"), "", false, "http://www.canadiangunnutz.com/forum/showthread.php/1355228-Lee-Enfield-EAL-3-digit-serial-Mint", "Firearm");

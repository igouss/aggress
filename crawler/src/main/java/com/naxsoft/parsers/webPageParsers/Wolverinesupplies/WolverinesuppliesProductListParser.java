...
public class WolverinesuppliesProductListParser extends AbstractWebPageParser {
    ...
    private Iterable<WebPageEntity> onCompleted(WebPageEntity parent) {
        ...
        try {
            ...
            if (0 != sb.length()) {
                WebPageEntity e = new WebPageEntity(parent, "productPage",
                        "https://www.wolverinesupplies.com/WebServices/ProductSearchService.asmx/GetItemsData?ItemNumbersString=" + sb, parent.getCategory());
            ...
            for (Element e : elements) {
                ...
                if (categoryMatcher.find()) {
                    ...
                    String productDetailsUrl =
                            "https://www.wolverinesupplies.com/WebServices/ProductSearchService.asmx/GetJSONItems?data={\"WordList\":\"\",\"ItemNumber\":\"\",\"CategoryCode\":"
                                    + productCategory + ",\"SearchMethod\":\"Category\",\"Limit\":0}";

...
class CabellasProductPageParser extends AbstractWebPageParser {
    ...
    public boolean canParse(WebPageEntity webPage) {
        return webPage.getUrl().contains("cabelas.ca") && webPage.getType().equals("productPage");
    }
    ...
    public void start() throws Exception {
        super.start();
        vertx.eventBus().consumer("cabelas.ca/productPage", getParseRequestMessageHandler());
    }
}

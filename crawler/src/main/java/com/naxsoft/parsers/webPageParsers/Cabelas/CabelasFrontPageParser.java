...
class CabelasFrontPageParser extends AbstractWebPageParser {
    ...
    private Observable<WebPageEntity> parseDocument(DownloadResult downloadResult) {
        ...
        if (document != null) {
            ...
            for (Element element : elements) {
                WebPageEntity webPageEntity = new WebPageEntity(downloadResult.getSourcePage(), "", "productList", false, element.attr("abs:href"), "");
    ...
    public void start() throws Exception {
        super.start();
        vertx.eventBus().consumer("cabelas.ca/frontPage", (Message<WebPageEntity> event) ->

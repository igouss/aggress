...
class HicalFrontPageParser extends AbstractWebPageParser {
    ...
    private Collection<WebPageEntity> parseDocument(DownloadResult downloadResult) {
        ...
        if (document != null) {
            ...
            for (Element element : elements) {
                WebPageEntity webPageEntity = new WebPageEntity(0L, "", "productList", false, element.attr("abs:href"), element.text());
    ...
    public void start() throws Exception {
        super.start();
        vertx.eventBus().consumer("hical.ca/frontPage", (Message<WebPageEntity> event) ->

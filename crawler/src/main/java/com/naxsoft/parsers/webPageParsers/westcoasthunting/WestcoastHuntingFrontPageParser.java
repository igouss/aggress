...
public class WestcoastHuntingFrontPageParser extends AbstractWebPageParser {
    ...
    public boolean canParse(WebPageEntity webPage) {
        return webPage.getUrl().contains("westcoasthunting.ca") && webPage.getType().equals("frontPage");
    }

    @Override
    public void start() throws Exception {
        super.start();
        vertx.eventBus().consumer("westcoasthunting.ca/frontPage", getParseRequestMessageHandler());
    }
}

...
class AlflahertysProductPageParser extends AbstractWebPageParser {
    ...
    public boolean canParse(WebPageEntity webPage) {
        return webPage.getUrl().contains("alflahertys.com") && webPage.getType().equals("productPage");
    }

    @Override
    public void start() throws Exception {
        super.start();
        vertx.eventBus().consumer("alflahertys.com/productPage", getParseRequestMessageHandler());
    }
}
